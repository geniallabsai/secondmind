...
Regras:
1. INÍCIO DE SESSÃO: leia `$VAULT/_system/VAULT-INDEX.md`, depois o MOC
   `02-projects/<projeto>.md`, depois as 2 últimas sessões do projeto.
...
4. Frontmatter YAML obrigatório em toda nota: `id, type, status, created,
   ...
   playbook}. Timestamps UTC ISO-8601.
...
6. Orçamento de tokens: inbox ≤150 · decision ≤500 · concept ≤600 ·
   session ≤900 · playbook ≤1200 · MOC ≤1000. Estourou? Divida, não acrescente.
7. FIM DE SESSÃO (obrigatório): preencher as 7 seções do template
   ...
   atualizar MOC e VAULT-INDEX; atualizar o manifest se disponível.
...
Em dúvida, leia o protocolo antes de agir.
